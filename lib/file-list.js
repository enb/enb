...
module.exports = inherit({
     ...
     *
     * Метод будет удалён в версии 1.0.0.
     * @deprecated
     */
    loadFromDirSync: function (dirname, recursive) {
        deprecate.deprecate({method: 'loadFromDirSync', module: 'file-list', since: 'v1.0.0'});
    ...
    loadFromDir: function (dirname, recursive) {
        deprecate.deprecate({method: 'loadFromDir', module: 'file-list', since: 'v1.0.0'});
...
function parseFilename(filename) {
    deprecate.deprecate({method: 'parseFilename', module: 'file-list', since: 'v1.0.0'});
