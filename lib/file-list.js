...
module.exports = inherit({
    ...
    loadFromDirSync: function (dirname, recursive) {
        deprecate({method: 'loadFromDirSync', module: 'file-list', since: 'v1.0.0'});
    ...
    loadFromDir: function (dirname, recursive) {
        deprecate({method: 'loadFromDir', module: 'file-list', since: 'v1.0.0'});
...
function parseFilename(filename) {
    deprecate({method: 'parseFilename', module: 'file-list', since: 'v1.0.0'});
