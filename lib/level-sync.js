...
module.exports = inherit({
    ...
    /**
     * Выставляет флаг загруженности уровня переопределения.
     */
    setLoaded: function() {
        this._loaded = true;
    },
    ...
    /**
     * Устанавливает структуру блоков.
     * Метод может быть полезен для загрузки уровня переопределения из кэша.
     * @param {Object} blocks
     */
