...
var Logger = module.exports = inherit(/** @lends Logger.prototype */ {
    ...
    __constructor: function (scope, options) {
        ...
        if (!this._options.logLevel) {
            this._options.logLevel = LOG_LEVELS[0];
        }
    },
    ...
    _buildMessage: function (msg, scope, action) {
        ...
        var hasFileLocation = /:\d+:\d+$/.test(scope);
        ...
        (scope && ('[' +
            colors.blue(
                hasFileLocation ? scope : scope.replace(/(:.+)$/, function (s, g) {
     ...
     * @returns {boolean}
     */
    _isLogLevelEnabled: function (level) {
