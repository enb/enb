...
module.exports = inherit(/** @lends MakePlatform.prototype */ {
    ...
    init: function (cdir, mode, config, opts) {
        ...
        return vowFs.makeDir(tmpDir).then(function () {
            ...
            _this._fileCache = new FileCache({
                root: cdir,
                tmpDir: tmpDir
            });
            _this._nodes = {};

            return _this._fileCache.init();
        });
    },
    ...
    /**
     * Устанавливает файловый кэш.
     * @param {FileCache} fileCache
     */
    setFileCache: function (fileCache) {
    ...
    buildTargets: function (targets) {
        var _this = this;
        this._cache = new Cache(this._cacheStorage, this._fileCache, this._projectName);
        try {
