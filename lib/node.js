...
function Node(nodePath, dirname, cache) {
    this._path = nodePath;
...
Node.prototype = {
    ...
    _resolveTargets: function(targets) {
        ...
        if (targets) {
            ...
            targetsToBuild = [].concat.apply([], targetsToBuild.map(function(targetName) {
                if (targetName == '*') {
                    return _this._targetNamesToBuild || Object.keys(_this._targetNames);
                } else {
                    return [targetName];
                }
            }));
    ...
    build: function(targets, buildCache) {
        ...
        return this._registerTargets().then(function(){
            return _this.requireSources(_this._resolveTargets(targets));
        });
    },
    ...
    clean: function(targets, buildCache) {
        ...
        this.buildCache = buildCache || {};
        return this._registerTargets().then(function(){
            return _this.cleanTargets(_this._resolveTargets(targets));
        });
    },
