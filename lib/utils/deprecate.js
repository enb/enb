 ...
 * @param {Object} [opts]
 * @param {boolean} [opts.showWarnings] Выводить предупреждения.
 */
...
/**
 * Сбрасывает внутренее состояние, после вызова deprecate считается неинициализированным.
 * Также удаляет все сообщения из очереди.
 */
...
/**
 * Показывает, была ли утилита инициализирована.
 * @returns {Boolean}
 */
