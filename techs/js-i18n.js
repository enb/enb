 ...
 * =======
 *
 * Берт собранный `js`-файл и добавляет в результат таргет `?.lang.<язык>.js`. Используется с технологией `i18n-lang-js`.
 *
 * **Опции**
 *
 * * *String* **target** — Результирующий таргет. По умолчанию — `?.{lang}.js`.
 * * *String* **lang** — Язык, для которого небходимо собрать файл.
 * * *String* **jsTarget** — Файл к которому покдлеится локализация. Если не указан, происходит сборка по чанкам `?.js`.
 *
 * **Пример**
 *
 * ```javascript
